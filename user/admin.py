...
from .models import common_member, common_member_star,follower_pair
...
class Common_memberAdmin(BaseUserAdmin):
    ...
    fieldsets = BaseUserAdmin.fieldsets + (
        ('personal info', {'fields': ('email_status','gender','posts','profile')}),
    )
...
class followersAdim(admin.ModelAdmin):
...
admin.site.register(follower_pair,followersAdim)
